...
sys.path.append( "/home/alex/python_programming/ABC/oo_sampler/results_smc")
...
theta_sampler = theta_sampler_mc
random_sequence = random_sequence_mc
name = "multiple_y_DICT_IS_large_mc_run"+kernel_name
IS = True
if True:
	...
	from functools import partial
		...
		# construct class
		smc_abc__ = smc_sampler_abc(epsilon, N_particles, delta, y_star, simulator, random_sequence, kernel, exclude_theta, 2, IS=IS, multiple_y = multiple_y)
		#partialize
