...
path = "/home/alex/python_programming/ABC_results_storage/simulation_results_20-4-17_new"
...
epsilon_start = 4
kwargs = {'N_particles_list': [20000],# 500, 750, 1500,   2500, 3000, 4000, 5000],#,],#,  3000, 4000, 5000], #[100,200,300,400,500,750,1000], #[1500, 2000, 2500, 3000, 4000, 5000],
...
if __name__ == '__main__':
    ...
    # simulation QMC
        ...
        kwargs['autochoose_eps'] = 'ess_based'
