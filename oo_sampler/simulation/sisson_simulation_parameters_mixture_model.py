# -*- coding: utf-8 -*-
"""
Created on Wed Jan 11 11:32:48 2017
    testing of the simulations for different parameter combinations
@author: alex
...
repetitions = 20
dim_particles = 2
kwargs = {'N_particles_list': [600,1000,2000],
            'dim_particles' : dim_particles,
            'Time' : Time,
            'dim_auxiliary_var' : 1,#20,
            'augment_M' : False,
            ...
            'kernel' : gaussian_densities_etc.uniform_kernel, #gaussian_kernel
            'move_theta' : gaussian_densities_etc.gaussian_move,
            'inititation_particles' : functions_mixture_model.theta_sampler_mc,
            ...
            'modified_sampling': "true sisson"}

K_repetitions = range(repetitions)
filename = 'true_sission'
