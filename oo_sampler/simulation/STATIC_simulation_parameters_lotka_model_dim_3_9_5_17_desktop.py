...
if True:
    ...
    plt.plot(quantiles*100, array_results_list[0].var(axis=2).sum(axis=2)[1,:], label="MC", linewidth=3, linestyle='dashed')
    plt.plot(quantiles*100, array_results_list[1].var(axis=2).sum(axis=2)[1,:], label="QMC", linewidth=3, linestyle='dotted')
    plt.plot(quantiles*100, array_results_list[2].var(axis=2).sum(axis=2)[1,:], label="RQMC", linewidth=3)
    plt.xlabel('Quantile of distance in percent', fontsize=14); plt.ylabel('Variance of estimator', fontsize=14)
    plt.yscale('log')
    ...
    plt.plot(quantiles*100, array_results_list[0].var(axis=2).sum(axis=2)[0,:], label="MC", linewidth=3, linestyle='dashed')
    plt.plot(quantiles*100, array_results_list[1].var(axis=2).sum(axis=2)[0,:], label="QMC", linewidth=3, linestyle='dotted')
    plt.plot(quantiles*100, array_results_list[2].var(axis=2).sum(axis=2)[0,:], label="RQMC", linewidth=3)
    plt.xlabel('Quantile of distance in percent', fontsize=14); plt.ylabel('Variance of estimator', fontsize=14)
    plt.yscale('log')
    plt.legend(fontsize=14)
