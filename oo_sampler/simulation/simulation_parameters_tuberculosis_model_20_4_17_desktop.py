...
path = "/media/alex/Transcend/ABC_results_storage/simulation_results_20-4-17_new"
...
epsilon_start = 4
kwargs = {'N_particles_list': [100],# 500, 750, 1500,   2500, 3000, 4000, 5000],#,],#,  3000, 4000, 5000], #[100,200,300,400,500,750,1000], #[1500, 2000, 2500, 3000, 4000, 5000],
