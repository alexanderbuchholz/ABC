...
filename = functions_model.model_string+'_adaptive_M_autochoose_eps_gaussian_kernel_1_VB_component_fixed_epsilon_schedule_algo_only_large_epsilon_desktop'
