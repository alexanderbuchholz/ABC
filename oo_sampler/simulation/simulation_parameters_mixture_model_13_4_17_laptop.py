...
path = "/home/alex/python_programming/ABC_results_storage/simulation_results_13-4-17"
...
epsilon_start = 4
kwargs = {'N_particles_list': [1000],# 10000 , 500, 750, 1500,   2500, 3000, 4000, 5000],#,],#,  3000, 4000, 5000], #[100,200,300,400,500,750,1000], #[1500, 2000, 2500, 3000, 4000, 5000],
